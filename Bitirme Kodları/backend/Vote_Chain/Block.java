...
public class Block {
	...
	public void mineBlock(int difficulty) {
		...
		System.out.println("Blok Mined Edildi!!! : " + hash);
	}
	...
	public boolean addTransaction(Transaction transaction) {
		...
		if((previousHash != "0")) {
			if((transaction.processTransaction() != true)) {
				System.out.println("Oy gönderme işlemi iptal edildi !");
				return false;
			}
		}
		transactions.add(transaction);
		System.out.println("Oy gönderme işlemi başarıyla bloğa eklendi");
		return true;
	}
}